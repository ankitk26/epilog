	...
	return (
		<form onSubmit={handleQuerySubmit}>
			<div className="relative">
				...
				<Input
					className="h-12 w-full rounded-full border-hairline-strong bg-card pr-4 pl-12 text-[15px] tracking-wide text-ink shadow-soft focus-visible:border-ink focus-visible:ring-0"
