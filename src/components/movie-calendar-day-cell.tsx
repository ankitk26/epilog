	...
	return (
		<>
			<div
				...
				className={cn(
					"col-span-1 flex min-h-14 w-full cursor-pointer flex-col gap-1 border border-border p-1 text-left text-xs transition-colors sm:min-h-20 sm:gap-2 sm:p-2 sm:text-xs lg:min-h-24 lg:p-3",
