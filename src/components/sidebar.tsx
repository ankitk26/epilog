		...
		<>
			...
			<aside
				className={cn(
					...
					isCollapsed
						? "w-64 -translate-x-full md:w-80 lg:w-16 lg:translate-x-0"
			...
			>
				<div className="flex items-center justify-between p-4 lg:p-6">
					<Link className="flex items-center" to="/">
						<h1
							className={cn(
								"text-base font-semibold tracking-wide transition-all duration-300 lg:text-lg",
