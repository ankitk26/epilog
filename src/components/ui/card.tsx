...
function Card({
	...
	return (
		<div
			...
			data-size={size}
			className={cn(
				"group/card flex flex-col gap-4 overflow-hidden rounded-lg bg-card py-5 text-xs/relaxed text-card-foreground ring-1 ring-border has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
				className,
			)}
			{...props}
		/>
